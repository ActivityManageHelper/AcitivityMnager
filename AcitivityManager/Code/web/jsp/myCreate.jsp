...
<div class="container">
    ...
    <div style="text-align: center;">
    	<span style="width: 50%;float: left;">
    		<a href="myJoin.jsp" style="color: #000000;" target="_self">我参加的</a>
    	</span>
        <span style="width: 50%;float: left;">
    		<a href="" style="padding-bottom: 5px;border-bottom:  2px solid #0000ff;color: #0000ff;">我创建的</a>
    	</span>
    </div>
</div>
    <%
        ...
        list = businessBean.getTableInfo(user_id,"activity");
        if(list.isEmpty()){
    %>
    <div style="text-align: center;">
        <div>
            <img src="../image/release.png" style="margin-top: 30%">
        </div>
        <p style="color: #9fc5e8;margin-top: 10px">您还未创建过活动，快去创建吧</p>
    </div>
    <%} else {
            ...
            <div class="mdui-card">
                <div class="mdui-card-media">
                    ...
                    <div class="mdui-card-menu">
                        <!--点击二维码图标，跳转到QRLinkServlet-->
                        <a href="../QRLinkServlet?id=<%=m.get("aty_id")%>">
                            <button class="mdui-btn mdui-btn-icon mdui-text-color-white"><i class="Hui-iconfont">&#xe6cb;</i></button>
                        </a>
                        <!--点击抽奖图标，跳转到lottery.jsp-->
                        <a href="lottery.jsp?id=<%=m.get("aty_id")%>&name=<%=m.get("aty_name")%>">
                            <button class="mdui-btn mdui-btn-icon mdui-text-color-white"><i class="Hui-iconfont">&#xe6bb;</i></button>
                        </a>
                        <!--点击查看详细图标，跳转到DetailServlet-->
